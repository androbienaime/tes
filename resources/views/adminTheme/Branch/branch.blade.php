        ...
        <form method="POST" action="{{ route("createBranch") }}">
            ...
            <div class="grid gap-6 mb-6 md:grid-cols-2 border p-2">
                ...
                <div>
                    ...
                    <x-input-admin type="text" name="country" required></x-input-admin>
                </div>

                <div>
                  <x-label-admin for="State">{{ __("State") }}</x-label-admin>
                  <x-input-admin type="text" name="State" required></x-input-admin>
                </div>
                
                <div>
                  <x-label-admin for="city">{{ __("City") }}</x-label-admin>
                  <x-input-admin type="text" name="city" required></x-input-admin>
                </div>
                
                <div>
                  <x-label-admin for="phone">{{ __("Phone") }}</x-label-admin>
                  <x-input-admin type="text" name="phone" required></x-input-admin>
                </div>
            </div> 
