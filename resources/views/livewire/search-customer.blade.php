            ...
            <div class="w-full px-4">
                <div x-data="selectConfigs()" x-init="" class="flex flex-col items-center relative">
                    <div class="w-full">
                        ...
                        <x-label-admin for="nameofcustomer">{{ __("Client name") }}</x-label-admin>
    ...
    <script type="text/javascript">
        function selectConfigs() {
            return {
                ...
                selectedName() { return this.selected ? this.selected.firstname + ' ' + this.selected.name : this.filter; },
                ...
                fetchOptions() {
                        fetch('/admin/api/getcustomers?search=' + this.filter)
                    ...
                    return this.options
                        ? this.options.filter(option => {
                            return (option.name.toLowerCase().indexOf(this.filter) > -1)
                                || (option.firstname.toLowerCase().indexOf(this.filter) > -1)
